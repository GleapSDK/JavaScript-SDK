  ...
  showScreenshotEditor(feedbackOptions) {
    ...
    for (var i = 0; i < toolbarItems.length; i++) {
      ...
      toolbarItem.onclick = function () {
        ...
        if (type === "pen") {
          /*if (active) {
            toolbarItem.classList.remove("bb-capture-toolbar-item--active");
          } else {
