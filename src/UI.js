...
export const loadIcon = function (name, color) {
  if (name === "button") {
    ...
    <path fill-rule="evenodd" clip-rule="evenodd" d="M23 30.9534C23 22.1426 30.1426 15 38.9534 15H105.047C113.857 15 121 22.1426 121 30.9534V96.015L121 96.0537V125.541C121 128.759 117.393 130.66 114.739 128.84L90.1189 111.968H38.9534C30.1426 111.968 23 104.826 23 96.015V30.9534ZM72 95.5537C85.3162 95.5537 96.1111 88.6842 96.1111 80.2102C96.1111 74.7347 92.5192 75.4201 86.3846 76.5907C83.0254 77.2317 78.9037 78.0183 74.1919 78.0183C69.7607 78.0183 65.3659 77.3226 61.474 76.7066C53.6706 75.4714 47.8889 74.5562 47.8889 80.2102C47.8889 88.6842 58.6838 95.5537 72 95.5537Z" fill="white"/>
    </svg>`;
  }
