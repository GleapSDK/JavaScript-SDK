...
export const loadIcon = function (name, color) {
  ...
  if (name === "undo") {
    return `<svg fill="${color}" width="1200pt" height="1200pt" version="1.1" viewBox="0 0 1200 1200" xmlns="http://www.w3.org/2000/svg">
    <path d="m684 504h-316.08l108-108c9.1992-8.6953 14.746-20.574 15.504-33.211 0.75781-12.641-3.3281-25.094-11.426-34.828-8.7969-9.793-21.23-15.547-34.387-15.91-13.16-0.36328-25.891 4.6953-35.215 13.988l-151.32 151.08c-19.879 19.871-31.047 46.828-31.047 74.938s11.168 55.07 31.047 74.941l148.92 149.04c8.7383 9.1172 20.617 14.574 33.227 15.266 12.609 0.6875 25.012-3.4375 34.695-11.543 9.793-8.7969 15.543-21.23 15.906-34.391 0.36328-13.156-4.6953-25.887-13.988-35.211l-109.92-110.16h316.08c33.703 0 66.812 8.8711 96 25.723 29.188 16.852 53.426 41.09 70.277 70.277 16.852 29.188 25.723 62.297 25.723 96v48c0 12.73 5.0586 24.938 14.059 33.941 9.0039 9 21.211 14.059 33.941 14.059s24.938-5.0586 33.941-14.059c9-9.0039 14.059-21.211 14.059-33.941v-48c0-76.383-30.344-149.64-84.352-203.65-54.012-54.008-127.27-84.352-203.65-84.352z"/>
   </svg>`;
  }
