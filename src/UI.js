...
export const loadIcon = function (name, color) {
  ...
  if (name === "recorderon") {
    return `<svg width="1200pt" height="1200pt" version="1.1" viewBox="0 0 1200 1200" xmlns="http://www.w3.org/2000/svg">
    <path d="m600 0c-159.13 0-311.74 63.215-424.27 175.73-112.52 112.52-175.73 265.14-175.73 424.27s63.215 311.74 175.73 424.27c112.52 112.52 265.14 175.73 424.27 175.73s311.74-63.215 424.27-175.73c112.52-112.52 175.73-265.14 175.73-424.27s-63.215-311.74-175.73-424.27c-112.52-112.52-265.14-175.73-424.27-175.73zm364.19 804.75-193.64-116.33v127.28c0 6.75-2.6797 13.227-7.4531 18-4.7773 4.7734-11.25 7.4531-18 7.4531h-431.14c-6.75 0-13.227-2.6797-18-7.4531-4.7734-4.7734-7.4531-11.25-7.4531-18v-431.23c0-6.7539 2.6797-13.227 7.4531-18 4.7734-4.7734 11.25-7.457 18-7.457h431.06c6.75 0 13.227 2.6836 18 7.457 4.7734 4.7734 7.457 11.246 7.457 18v127.28l193.64-116.34z" fill="#fff"/>
   </svg>`;
  }

  if (name === "recorderoff") {
    return `<svg width="1200pt" height="1200pt" version="1.1" viewBox="0 0 1200 1200" xmlns="http://www.w3.org/2000/svg">
    <path d="m600 60c-298.8 0-540 241.2-540 540s241.2 540 540 540 540-241.2 540-540-241.2-540-540-540zm237.6 741.6c0 20.398-15.602 36-36 36h-403.2c-20.398 0-36-15.602-36-36v-403.2c0-20.398 15.602-36 36-36h403.2c20.398 0 36 15.602 36 36z" fill="#fff"/>
  </svg>`;
  }
