...
AutoConfig_defineProperty(AutoConfig, "run", function (applyFunc) {
  var cachedConfig = loadFromGleapCache("config");
...
AutoConfig_defineProperty(AutoConfig, "loadConfigFromServer", function (applyFunc, soft) {
  return new Promise(function (resolve, reject) {
